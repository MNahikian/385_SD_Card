...
module DE2_115_SD_CARD_NIOS_mm_interconnect_0 (
	...
	wire    [9:0] cmd_mux_001_src_channel;                                                                   // cmd_mux_001:src_channel -> Altera_UP_SD_Card_Avalon_Interface_0_avalon_sdcard_slave_agent:cp_channel
	...
	wire  [106:0] cmd_mux_002_src_data;                                                                      // cmd_mux_002:src_data -> cpu_jtag_debug_module_agent:cp_data
	...
	wire    [9:0] cmd_mux_003_src_channel;                                                                   // cmd_mux_003:src_channel -> altpll_pll_slave_agent:cp_channel
	...
	wire  [106:0] cmd_mux_005_src_data;                                                                      // cmd_mux_005:src_data -> onchip_memory2_s1_agent:cp_data
	...
	wire          cmd_mux_006_src_valid;                                                                     // cmd_mux_006:src_valid -> sma_in_s1_agent:cp_valid
	wire  [106:0] cmd_mux_006_src_data;                                                                      // cmd_mux_006:src_data -> sma_in_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                                     // sma_in_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [9:0] cmd_mux_006_src_channel;                                                                   // cmd_mux_006:src_channel -> sma_in_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                             // cmd_mux_006:src_startofpacket -> sma_in_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                               // cmd_mux_006:src_endofpacket -> sma_in_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                                     // cmd_mux_007:src_valid -> sma_out_s1_agent:cp_valid
	wire  [106:0] cmd_mux_007_src_data;                                                                      // cmd_mux_007:src_data -> sma_out_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                                     // sma_out_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [9:0] cmd_mux_007_src_channel;                                                                   // cmd_mux_007:src_channel -> sma_out_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                             // cmd_mux_007:src_startofpacket -> sma_out_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                               // cmd_mux_007:src_endofpacket -> sma_out_s1_agent:cp_endofpacket
	...
	wire  [106:0] cmd_mux_008_src_data;                                                                      // cmd_mux_008:src_data -> sdram_controller_s1_agent:cp_data
	...
	wire  [106:0] cpu_jtag_debug_module_agent_rp_data;                                                       // cpu_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [106:0] onchip_memory2_s1_agent_rp_data;                                                           // onchip_memory2_s1_agent:rp_data -> router_007:sink_data
	...
	wire          sma_in_s1_agent_rp_valid;                                                                  // sma_in_s1_agent:rp_valid -> router_008:sink_valid
	wire  [106:0] sma_in_s1_agent_rp_data;                                                                   // sma_in_s1_agent:rp_data -> router_008:sink_data
	wire          sma_in_s1_agent_rp_ready;                                                                  // router_008:sink_ready -> sma_in_s1_agent:rp_ready
	wire          sma_in_s1_agent_rp_startofpacket;                                                          // sma_in_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          sma_in_s1_agent_rp_endofpacket;                                                            // sma_in_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          sma_out_s1_agent_rp_valid;                                                                 // sma_out_s1_agent:rp_valid -> router_009:sink_valid
	wire  [106:0] sma_out_s1_agent_rp_data;                                                                  // sma_out_s1_agent:rp_data -> router_009:sink_data
	wire          sma_out_s1_agent_rp_ready;                                                                 // router_009:sink_ready -> sma_out_s1_agent:rp_ready
	wire          sma_out_s1_agent_rp_startofpacket;                                                         // sma_out_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          sma_out_s1_agent_rp_endofpacket;                                                           // sma_out_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [106:0] sdram_controller_s1_agent_rp_data;                                                         // sdram_controller_s1_agent:rp_data -> router_010:sink_data
	...
	wire          cfi_flash_uas_agent_rp_valid;                                                              // cfi_flash_uas_agent:rp_valid -> router_011:sink_valid
	wire   [79:0] cfi_flash_uas_agent_rp_data;                                                               // cfi_flash_uas_agent:rp_data -> router_011:sink_data
	wire          cfi_flash_uas_agent_rp_ready;                                                              // router_011:sink_ready -> cfi_flash_uas_agent:rp_ready
	wire          cfi_flash_uas_agent_rp_startofpacket;                                                      // cfi_flash_uas_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          cfi_flash_uas_agent_rp_endofpacket;                                                        // cfi_flash_uas_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire    [9:0] cfi_flash_uas_burst_adapter_source0_channel;                                               // cfi_flash_uas_burst_adapter:source0_channel -> cfi_flash_uas_agent:cp_channel
	...
	wire    [9:0] cmd_demux_001_src3_channel;                                                                // cmd_demux_001:src3_channel -> cmd_mux_009:sink1_channel
	...
	wire    [9:0] rsp_demux_009_src1_channel;                                                                // rsp_demux_009:src1_channel -> rsp_mux_001:sink3_channel
	...
	wire          router_011_src_valid;                                                                      // router_011:src_valid -> cfi_flash_uas_rsp_width_adapter:in_valid
	wire   [79:0] router_011_src_data;                                                                       // router_011:src_data -> cfi_flash_uas_rsp_width_adapter:in_data
	wire          router_011_src_ready;                                                                      // cfi_flash_uas_rsp_width_adapter:in_ready -> router_011:src_ready
	wire    [9:0] router_011_src_channel;                                                                    // router_011:src_channel -> cfi_flash_uas_rsp_width_adapter:in_channel
	wire          router_011_src_startofpacket;                                                              // router_011:src_startofpacket -> cfi_flash_uas_rsp_width_adapter:in_startofpacket
	wire          router_011_src_endofpacket;                                                                // router_011:src_endofpacket -> cfi_flash_uas_rsp_width_adapter:in_endofpacket
	wire          cfi_flash_uas_rsp_width_adapter_src_valid;                                                 // cfi_flash_uas_rsp_width_adapter:out_valid -> rsp_demux_009:sink_valid
	wire  [106:0] cfi_flash_uas_rsp_width_adapter_src_data;                                                  // cfi_flash_uas_rsp_width_adapter:out_data -> rsp_demux_009:sink_data
	wire          cfi_flash_uas_rsp_width_adapter_src_ready;                                                 // rsp_demux_009:sink_ready -> cfi_flash_uas_rsp_width_adapter:out_ready
	wire    [9:0] cfi_flash_uas_rsp_width_adapter_src_channel;                                               // cfi_flash_uas_rsp_width_adapter:out_channel -> rsp_demux_009:sink_channel
	wire          cfi_flash_uas_rsp_width_adapter_src_startofpacket;                                         // cfi_flash_uas_rsp_width_adapter:out_startofpacket -> rsp_demux_009:sink_startofpacket
	wire          cfi_flash_uas_rsp_width_adapter_src_endofpacket;                                           // cfi_flash_uas_rsp_width_adapter:out_endofpacket -> rsp_demux_009:sink_endofpacket
	wire          cmd_mux_009_src_valid;                                                                     // cmd_mux_009:src_valid -> cfi_flash_uas_cmd_width_adapter:in_valid
	wire  [106:0] cmd_mux_009_src_data;                                                                      // cmd_mux_009:src_data -> cfi_flash_uas_cmd_width_adapter:in_data
	wire          cmd_mux_009_src_ready;                                                                     // cfi_flash_uas_cmd_width_adapter:in_ready -> cmd_mux_009:src_ready
	wire    [9:0] cmd_mux_009_src_channel;                                                                   // cmd_mux_009:src_channel -> cfi_flash_uas_cmd_width_adapter:in_channel
	wire          cmd_mux_009_src_startofpacket;                                                             // cmd_mux_009:src_startofpacket -> cfi_flash_uas_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                               // cmd_mux_009:src_endofpacket -> cfi_flash_uas_cmd_width_adapter:in_endofpacket
	...
	wire    [9:0] cfi_flash_uas_cmd_width_adapter_src_channel;                                               // cfi_flash_uas_cmd_width_adapter:out_channel -> cfi_flash_uas_burst_adapter:sink0_channel
	...
	wire    [9:0] crosser_001_out_channel;                                                                   // crosser_001:out_channel -> cmd_mux_008:sink0_channel
	...
	wire    [9:0] cmd_demux_001_src2_channel;                                                                // cmd_demux_001:src2_channel -> crosser_002:in_channel
	...
	wire    [9:0] crosser_002_out_channel;                                                                   // crosser_002:out_channel -> cmd_mux_008:sink1_channel
	...
	wire  [106:0] rsp_demux_003_src0_data;                                                                   // rsp_demux_003:src0_data -> crosser_003:in_data
	wire          rsp_demux_003_src0_ready;                                                                  // crosser_003:in_ready -> rsp_demux_003:src0_ready
	wire    [9:0] rsp_demux_003_src0_channel;                                                                // rsp_demux_003:src0_channel -> crosser_003:in_channel
	...
	wire  [106:0] crosser_003_out_data;                                                                      // crosser_003:out_data -> rsp_mux:sink3_data
	wire          crosser_003_out_ready;                                                                     // rsp_mux:sink3_ready -> crosser_003:out_ready
	wire    [9:0] crosser_003_out_channel;                                                                   // crosser_003:out_channel -> rsp_mux:sink3_channel
	...
	wire    [9:0] crosser_004_out_channel;                                                                   // crosser_004:out_channel -> rsp_mux:sink8_channel
	...
	wire    [9:0] rsp_demux_008_src1_channel;                                                                // rsp_demux_008:src1_channel -> crosser_005:in_channel
	...
	wire    [9:0] crosser_005_out_channel;                                                                   // crosser_005:out_channel -> rsp_mux_001:sink2_channel
	...
	wire          sma_in_s1_agent_rdata_fifo_src_valid;                                                      // sma_in_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] sma_in_s1_agent_rdata_fifo_src_data;                                                       // sma_in_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          sma_in_s1_agent_rdata_fifo_src_ready;                                                      // avalon_st_adapter_006:in_0_ready -> sma_in_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                         // avalon_st_adapter_006:out_0_valid -> sma_in_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                          // avalon_st_adapter_006:out_0_data -> sma_in_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                         // sma_in_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                         // avalon_st_adapter_006:out_0_error -> sma_in_s1_agent:rdata_fifo_sink_error
	wire          sma_out_s1_agent_rdata_fifo_src_valid;                                                     // sma_out_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] sma_out_s1_agent_rdata_fifo_src_data;                                                      // sma_out_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          sma_out_s1_agent_rdata_fifo_src_ready;                                                     // avalon_st_adapter_007:in_0_ready -> sma_out_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                         // avalon_st_adapter_007:out_0_valid -> sma_out_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                          // avalon_st_adapter_007:out_0_data -> sma_out_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                         // sma_out_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                         // avalon_st_adapter_007:out_0_error -> sma_out_s1_agent:rdata_fifo_sink_error
	...
	wire          cfi_flash_uas_agent_rdata_fifo_out_valid;                                                  // cfi_flash_uas_agent_rdata_fifo:out_valid -> avalon_st_adapter_009:in_0_valid
	wire    [9:0] cfi_flash_uas_agent_rdata_fifo_out_data;                                                   // cfi_flash_uas_agent_rdata_fifo:out_data -> avalon_st_adapter_009:in_0_data
	wire          cfi_flash_uas_agent_rdata_fifo_out_ready;                                                  // avalon_st_adapter_009:in_0_ready -> cfi_flash_uas_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_009_out_0_valid;                                                         // avalon_st_adapter_009:out_0_valid -> cfi_flash_uas_agent:rdata_fifo_sink_valid
	wire    [9:0] avalon_st_adapter_009_out_0_data;                                                          // avalon_st_adapter_009:out_0_data -> cfi_flash_uas_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                                         // cfi_flash_uas_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                                         // avalon_st_adapter_009:out_0_error -> cfi_flash_uas_agent:rdata_fifo_sink_error
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_router_002 router_003 (
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_router_004 router_004 (
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_router_002 router_006 (
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_router_004 router_007 (
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_router_002 router_009 (
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_router_004 router_010 (
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_router_011 router_011 (
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (altpll_c0_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (altpll_c0_clk),                                     //       clk.clk
		.reset               (onchip_memory2_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_cmd_mux_002 cmd_mux_008 (
		.clk                 (sys_sdram_pll_0_sdram_clk_clk),                      //       clk.clk
		.reset               (sdram_controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_cmd_mux_002 cmd_mux_009 (
		.clk                 (altpll_c0_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (altpll_c0_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (altpll_c0_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_rsp_demux_008 rsp_demux_008 (
		.clk                (sys_sdram_pll_0_sdram_clk_clk),                      //       clk.clk
		.reset              (sdram_controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_avalon_st_adapter_009 #(
		.inBitsPerSymbol (10),
		.inUsePackets    (0),
		.inDataWidth     (10),
		.inChannelWidth  (0),
